...
<script src="js/bootstrap.js"></script> 
    ...
    <![endif]-->
	<style>		.selected{			/*border: 4px solid #4390df;*/			border: 4px solid #d43f3a;		}		.selected::before {		  color: #fff;		  content: "\f00c";		  display: block;		  font-family: "FontAwesome";		  font-size: 10pt;		  font-weight: normal;		  position: absolute;		  right: 2px;		  top: 0;		  z-index: 102;		}		.selected::after {		  border-left: 32px solid transparent;		  border-top: 32px solid #d43f3a;		  content: "";		  display: block;		  position: absolute;		  right: 0;		  top: 0;		  z-index: 101;		}		.btn_selection .selectedTheme{			border-radius: 0 0 30px 30px;			display: block;			margin: auto;			padding-top: 2px;		}		.mfp-title{			text-align:center !important;		}
		.category span
		{
...
<script type="text/javascript">function charCount(ele,remainingCount){	$(ele).closest('.inputArea').find('span').html(remainingCount);}jQuery(function($) {	$('.inputArea textarea').bind('keydown keyup keypress', function() {		charCount(this,$(this).attr('maxlength')-this.value.length);	});	$('[id^=q_]').bind('keydown keyup keypress', function() {		var qid = $(this).attr('id').replace ( /[^\d.]/g, '' );		var questionNum = parseInt(qid,10);		$('#'+questionNum).html($(this).val() || "_"+questionNum+"_");	});});
</script>
