...
//Counter for input text area
function charCount(ele,remainingCount){
	$(ele).closest('.inputArea').find('span').html(remainingCount);
}
jQuery(function($) {
	//Creating para using input
	$('[id^=q_]').bind('keydown keyup keypress', function() {
		var qid = $(this).attr('id').replace ( /[^\d.]/g, '' );
		var questionNum = parseInt(qid,10);
		$('#'+questionNum).html($(this).val() || "_"+questionNum+"_");
		charCount(this,30-this.value.length);
	});
});
</script>
			...
			<div class="col-md-6">
				<form role="form">
					...
					<div class="form-group">
						...
						<div class="input-group">
							<input type="text" class="form-control" name="" placeholder="Enter Alias Name" required/>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="date" class="form-control" name="" placeholder="Select your DOB" />
						</div>
					</div>
					<div class="form-group">
						<div class="row">
						...
						<div class="input-group">
							<input type="email" class="form-control" name="" placeholder="Enter Your Email" required/>
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" name="" placeholder="Enter Your Mobile" required/>
						</div>
...
<section class="content">
    <div class="container">
        ...
        <div class="row">
            <div class="owl-carousel latest-videos vartha-animation" data-animation="fadeIn">
				<div class="profile_themes">
					<img alt="profiles_design02" src="profilethemes/profiles_design02.jpg" width="50%" class="video-item">
				...
				<div class="profile_themes">
					<img alt="profiles_design03" src="profilethemes/profiles_design03.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design04" src="profilethemes/profiles_design04.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design05" src="profilethemes/profiles_design05.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design06" src="profilethemes/profiles_design06.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design07" src="profilethemes/profiles_design07.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design08" src="profilethemes/profiles_design08.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design09" src="profilethemes/profiles_design09.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design10" src="profilethemes/profiles_design10.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design11" src="profilethemes/profiles_design11.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design14" src="profilethemes/profiles_design14.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design15" src="profilethemes/profiles_design15.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design16" src="profilethemes/profiles_design16.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
				...
				<div class="profile_themes">
					<img alt="profiles_design17" src="profilethemes/profiles_design17.jpg" class="video-item">
					<div class="button-overlay">
						<button class="btn btn-primary">Select </button>
						<button class="btn btn-danger">Preview </button>
					</div>
                ...
                <!--<a href="http://www.youtube.com/embed/1iIZeIy7TqM?rel=0&amp;wmode=transparent" class="video-gallery  border-img-hover">
                    <img alt="Video 10" src="img/demo/videos/video-10.jpg" class="video-item">
                    <div class="video-icon-overlay">
                        <div class="video-icon-wrap">
                            <i class="fa fa-play-circle-o text-center video-icon"></i>
                        </div> 
                    </div>
                </a> -->
            </div><!-- End Owl Carousel Latest Videos -->
        </div><!-- End Row -->
    </div><!-- End Container -->
	<input type="hidden" value="" name="user_template_selection" id="user_template_selection">
	<script>
		$('.profile_themes').click(function(){
			/*alert('click');
			$(this).find('img').clone().appendTo('.modal-body');
			$('#myModal').modal('show');*/
			$('#user_template_selection').val($(this).find('img').attr('src'));
		});
	</script>
...
<script>
$('profile_themes').hover(function(){
	alert('hover');
	$(this).find('.button-overlay').show();
},
function(){
	$(this).find('.button-overlay').hide();
});
(function($) {
  "use strict";
	//Initalize Search
